    ...
    <div>
        ...
        <div>
            <asp:RadioButtonList ID="rdOperations" runat="server" OnSelectedIndexChanged="rdOperations_SelectedIndexChanged" AutoPostBack="True">
                ...
                <asp:ListItem Value="rd_Source">Update Source</asp:ListItem>
            </asp:RadioButtonList>
        </div>

        <div>
            <asp:Panel runat="server" ID="pnl_sources" Visible="false">
                <asp:DropDownList runat="server" ID="ddl_sources">
                    <asp:ListItem Value="DHA">DHA</asp:ListItem>
                    <asp:ListItem Value="MOH">MOH</asp:ListItem>
                    <asp:ListItem Value="ALL">ALL</asp:ListItem>
                    <asp:ListItem Value="HAAD">HAAD</asp:ListItem>
                    <asp:ListItem Value="DHC">DHC</asp:ListItem>
                </asp:DropDownList>
            </asp:Panel>
        </div>
