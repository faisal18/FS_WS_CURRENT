...
{
    public partial class ClearingHouse_eClaimExpress : System.Web.UI.Page
    {
        ...
        protected void btnRstrtIIS_Click(object sender, EventArgs e)
        {
            ...
            txtStatus.Text = Helpers.BatchFIleCaller.CallBatchFile(userid, "ClearingHouse-eClaimExpress-UAT");
            if (txtStatus.Text != "")
            {
        ...
        protected void btnPBMProd_Click(object sender, EventArgs e)
        {
            ...
            //txtStatus.Text = Helpers.BatchFIleCaller.CallBatchFile( userid, "PBMSWITCH-PROD");
            txtStatus.Text = Helpers.BatchFIleCaller.CallBatchFile(userid, "ClearingHouse-eClaimExpress-Production");
            if (txtStatus.Text != "")
            {
                int StatusCode = int.Parse(txtStatus.Text.Split('\n').Reverse().Take(1).ToArray()[0]);
