...
{
    public partial class eClaimLink : System.Web.UI.Page
    {
        ...
        protected void btnRstrtIIS_Click(object sender, EventArgs e)
        {
            ...
            txtStatus.Text = Helpers.BatchFIleCaller.CallBatchFile(userid, "eClaimlink-UAT");
            if (txtStatus.Text != "")
            {
        ...
        protected void btnPBMProd_Click(object sender, EventArgs e)
        {
            ...
            //txtStatus.Text = Helpers.BatchFIleCaller.CallBatchFile( userid, "PBMSWITCH-PROD");
            txtStatus.Text = Helpers.BatchFIleCaller.CallBatchFile(userid, "eClaimlink-Prod");
