...
+ ' ,(select activity_ID as ID,Convert(varchar(10),start_date,103) +'' ''+ Convert(varchar(5),start_date,8) as ''Start'',type as ''Type'',code as Code'
+' ,(CASE'+
...
'	END) AS ''Quantity'','+
+'  Convert(decimal(20,2),net) as ''Net'',Clinician '
+ ','
+ ' ('
