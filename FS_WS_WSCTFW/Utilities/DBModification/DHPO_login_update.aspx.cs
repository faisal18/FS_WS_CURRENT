...
{
    public partial class DHPO_login_update : System.Web.UI.Page
    {
        ExtraClasses.DHPO_login_update dhpo_log = new ExtraClasses.DHPO_login_update();
        ...
        protected void submit_Click(object sender, EventArgs e)
        {
            if (rd_all.Checked == true)
            {
                ...
                {
                    string message = dhpo_log.script(txt_license.Text.ToString(), txt_username.Text.ToString(), txt_password.Text.ToString());
            ...
            else if (rd_passwod.Checked == true)
            {
                ...
                {
                    string message = dhpo_log.script(txt_license.Text.ToString(), txt_password.Text.ToString());
                    txt_richbox.InnerText = message.ToString();
                }
                else
        ...
        protected void lbl_generate_Click(object sender, EventArgs e)
        {
            if (rd_all.Checked == true)
            {
                txt_richbox.InnerText = dhpo_log.generate_query(txt_license.Text.ToString(), txt_username.Text.ToString(), txt_password.Text.ToString());
            }
            else if (rd_passwod.Checked == true)
            {
                txt_richbox.InnerText = dhpo_log.generate_query(txt_license.Text.ToString(), txt_password.Text.ToString());
            }
        }
    }
}