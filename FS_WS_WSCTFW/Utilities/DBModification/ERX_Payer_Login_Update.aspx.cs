...
{
    public partial class ERX_Payer_Login_Update : System.Web.UI.Page
    {
        ...
        ExtraClasses.erx_payer_login_update erx_payer = new ExtraClasses.erx_payer_login_update();
        ...
        protected void lbl_generate_Click(object sender, EventArgs e)
        {
            ...
            {
                txt_richbox.InnerText = erx_payer.generate_query(txt_license.Text.ToString(), txt_username.Text.ToString(), txt_password.Text.ToString());
            }
            else if (rd_passwod.Checked == true)
            {
                txt_richbox.InnerText = erx_payer.generate_query(txt_license.Text.ToString(), txt_password.Text.ToString());
            }
        }
        ...
        protected void submit_Click(object sender, EventArgs e)
        {
            if (rd_all.Checked == true)
            {
                ...
                {
                    string message = erx_payer.script(txt_license.Text.ToString(), txt_username.Text.ToString(), txt_password.Text.ToString());
            ...
            else if (rd_passwod.Checked == true)
            {
                ...
                {
                    string message = erx_payer.script(txt_license.Text.ToString(), txt_password.Text.ToString());
                    txt_richbox.InnerText = message.ToString();
                }
                else
