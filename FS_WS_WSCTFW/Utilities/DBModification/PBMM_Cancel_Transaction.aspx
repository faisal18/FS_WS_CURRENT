<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="PBMM_Cancel_Transaction.aspx.cs" Inherits="ClinicianAutomation.Utilities_UI.PBMM_Cancel_Transaction" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">

    <div id="title">
        <h1>PBM Switch: Cancel Transaction</h1>
