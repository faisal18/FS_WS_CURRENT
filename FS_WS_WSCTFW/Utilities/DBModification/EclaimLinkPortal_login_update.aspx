<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="EclaimLinkPortal_login_update.aspx.cs" Inherits="ClinicianAutomation.EclaimLinkPortal_login_update" %>

<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <div id="title">
        <h1>Eclaim Link Portal Login Update</h1>
