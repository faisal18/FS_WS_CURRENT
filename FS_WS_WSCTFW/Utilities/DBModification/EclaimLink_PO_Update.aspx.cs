...
{
    public partial class EclaimLink_PO_Update : System.Web.UI.Page
    {

        ExtraClasses.EclaimLink_Po_update ecl_po = new ExtraClasses.EclaimLink_Po_update();
        ...
        protected void submit_Click(object sender, EventArgs e)
        {
            if (rd_all.Checked == true)
            {
                ...
                {
                    string message = ecl_po.script(txt_license.Text.ToString(), txt_username.Text.ToString(), txt_password.Text.ToString());
            ...
            else if (rd_passwod.Checked == true)
            {
                ...
                {
                    string message = ecl_po.script(txt_license.Text.ToString(), txt_password.Text.ToString());
                    txt_richbox.InnerText = message.ToString();
                }
                else
        ...
        protected void lbl_generate_Click(object sender, EventArgs e)
        {
            if (rd_all.Checked == true)
            {
                txt_richbox.InnerText = ecl_po.generate_query(txt_license.Text.ToString(), txt_username.Text.ToString(), txt_password.Text.ToString());
            }
            else if (rd_passwod.Checked == true)
            {
                txt_richbox.InnerText = ecl_po.generate_query(txt_license.Text.ToString(), txt_password.Text.ToString());
            }
        }
    }
}