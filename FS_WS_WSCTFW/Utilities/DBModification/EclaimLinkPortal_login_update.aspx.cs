...
{
    public partial class EclaimLinkPortal_login_update : System.Web.UI.Page
    {

        ExtraClasses.EclaimLinkPortal_login_update eclp_login = new ExtraClasses.EclaimLinkPortal_login_update();
        ...
        protected void submit_Click(object sender, EventArgs e)
        {
            if (rd_all.Checked == true)
            {
                ...
                {
                    string message = eclp_login.script(txt_license.Text.ToString(), txt_username.Text.ToString(), txt_password.Text.ToString());
            ...
            else if (rd_passwod.Checked == true)
            {
                ...
                {
                    string message = eclp_login.script(txt_license.Text.ToString(), txt_password.Text.ToString());
                    txt_richbox.InnerText = message.ToString();
                }
                else
        ...
        protected void lbl_generate_Click(object sender, EventArgs e)
        {
            if (rd_all.Checked == true)
            {
                txt_richbox.InnerText = eclp_login.generate_query(txt_license.Text.ToString(), txt_username.Text.ToString(), txt_password.Text.ToString());
            }
            else if (rd_passwod.Checked == true)
            {
                txt_richbox.InnerText = eclp_login.generate_query(txt_license.Text.ToString(), txt_password.Text.ToString());
            }
        }
    }
}