<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ERX_Login_Update.aspx.cs" Inherits="ClinicianAutomation.ERX_Login_Update" %>

<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <div id="title">
        <h1>Provider Erx login Update</h1>
    </div>
    <div id="content">
        <div>
