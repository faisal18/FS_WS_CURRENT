<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="EclaimLink_Login_Update.aspx.cs" Inherits="ClinicianAutomation.EclaimLink_Login_Update" %>

<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <div id="title">
        <h1>Eclaim Link Login Update</h1>
    </div>
    <div id="content">
        <div>
