...
+ ' ,(select ID as ID,Convert(varchar(10),start_date,103) +'' ''+ Convert(varchar(5),start_date,8) as ''Start'',type as ''Type'',code as Code,(case when P.Region = 2 THEN (Convert(decimal(9,2),PRA.pbm_quantity)) when P.Region != 2 THEN (Convert(decimal(9,2),PRA.quantity)) END) as ''Quantity'',Convert(decimal(9,2),net) as ''Net'',Clinician '
+ ','
+ ' ('
