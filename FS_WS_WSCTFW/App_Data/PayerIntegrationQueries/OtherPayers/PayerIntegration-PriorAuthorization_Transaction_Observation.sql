...
insert @Payerid(Payers) values (1),(3),(4),(5),(7),(54),(1247),(1285),(1333),(1325),(1350),(1364)
...
'				(CASE when Prov.Region = 2 then Convert(decimal(10,2),(PAA.drug_quantity * (select DCR.granual_units from PBMM..DRUG_CODE_REF DCR with (nolock) where DCR.id = PAA.drug_id))) when Prov.Region != 2 then Convert(decimal(10,2),(PAA.drug_quantity)) END) as ''Quantity'','+
'				Convert(decimal(15,2),PAA.drug_net) as ''Net'','+
...
'				   ,(select ''Text'' AS ''Type'',''Requested_Net'' AS ''Code'',Convert(decimal(10,2),PAA.drug_gross) AS ''Value'',''Requested_Net'' AS ''ValueType'' FOR XML PATH (''Observation''),TYPE), '+
